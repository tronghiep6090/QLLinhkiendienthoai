            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <div class="select-role">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn active">
                                    ...
                                    <div class="icon"><img src="public/frontend/vendors/images/briefcase.svg"
                                            class="svg" alt=""></div>
                                    <span>I'm</span>
                                    Manager
                                </label>
                                <label class="btn">
                                    ...
                                    <div class="icon"><img src="public/frontend/vendors/images/person.svg"
                                            class="svg" alt=""></div>
                                    <span>I'm</span>
                                    Employee
                                </label>
                        ...
                        <form class="sign-up-form form" action="{{ URL::to('/login') }}" enctype="multipart/form-data"
                            method="POST">
                            {{ csrf_field() }}
                            <div class="input-group custom">
                                <!-- <input type="text" class="form-control form-control-lg" placeholder="Username" name="username"> -->
                                <input class="form-control form-control-lg" name="username" id="usrname" type="text"
                            ...
                            <div class="input-group custom">
                                ...
                                <input class="form-control form-control-lg" name="password" id="psw" type="password"
                            ...
                            <div class="row pb-30">
                                ...
                                <div class="col-6">
                                    <div class="forgot-password"><a href="{{ URL::to('/forgotpassword') }}">Forgot
                                            Password</a></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group mb-0">
                                        <a class="btn btn-outline-primary btn-lg btn-block"
                                            href="{{ URL::to('/register') }}">Register To Create Account</a>
                                    </div>
                                </div>
                            </div>
                        </form>
