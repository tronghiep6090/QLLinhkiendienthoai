							...
							<div class="row align-items-center">
								<div class="col-5">
									<div class="input-group mb-0">
										...
										-->
										<a class="btn btn-primary btn-lg btn-block" href="{{URL::to('/changepassword')}}">Submit</a>
									</div>
								</div>
								<div class="col-2">
								...
								<div class="col-5">
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="{{URL::to('/login')}}">Login</a>
									</div>
								</div>
							</div>
						</form>
