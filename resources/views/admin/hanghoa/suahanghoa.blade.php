...
<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Sửa hàng hóa</h4>
						</div>
						...
						<form action="{{URL::to('/update-product/'.$edit_value->id_HH)}}" enctype="multipart/form-data" method="post">
							...
							<div class="pull-right">
								<button type="submit" name="add_brand_product" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i ></i>Sửa</button>
							</div>
								</code></pre>
							</div>
						</div>
